...
export function listPassenger(params = {}) {
  ...
  return http.get(MODULE_PREFIX + '/admin/passenger/list', {
    params: {
      page,
      size,
      keyword
...
export function savePassenger(data) {
  return http.post(MODULE_PREFIX + '/admin/passenger/save', data)
}

export function deletePassenger(id) {
  return http.delete(MODULE_PREFIX + '/admin/passenger/' + id)
}
